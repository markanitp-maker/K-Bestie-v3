...
| 100 Legal Consent Master | 🟡 게이트① 재리뷰 대기 | 반려 4건([복잡] 3건+[단순] 1건) 수정·셀프검증 완료: Legal 공개 fail-closed, 동의 버전 Registry 단일화, 설정 화면 관심사 신규 수집 제거, 마케팅 채널 중앙 설정 연결. `tsc`·Legal release 분기 검증 PASS. 배포·DB 변경·커밋 없음 |
