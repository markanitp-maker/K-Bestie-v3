      ...
      {showRecovery && (
        <div className="mx-4 mt-3 rounded-2xl border border-amber-200 bg-amber-50 p-3 text-sm text-[#172A46]">
          <div className="flex items-center justify-between gap-3">
            <p>{unsupported ? "현재 브라우저에서 알림을 지원하지 않아요. 앱의 다른 기능은 계속 이용할 수 있어요." : denied ? "알림이 차단되어 있어요." : role === "parent" ? "아침 리포트 알림이 꺼져 있어요. 아이의 리포트가 준비되면 알려드릴까요?" : "미션 알림이 꺼져 있어요. 시작 시간을 놓치지 않도록 알림을 켜주세요."}</p>
