...
function MissionInner({
  onTextModeChange,
  onKeyboardViewportMetricsChange,
}: {
  onTextModeChange?: (isTextMode: boolean) => void;
  onKeyboardViewportMetricsChange?: (metrics: { height: number; pageTop: number } | null) => void;
}) {
  ...
  return (
    <>
      ...
      <MissionConversationLayout
        ...
        onKeyboardViewportMetricsChange={onKeyboardViewportMetricsChange}
...
function MissionRouteGate() {
  ...
  const [mobileViewportMetrics, setMobileViewportMetrics] = useState<{
    height: number;
    pageTop: number;
  } | null>(null);
  ...
  return (
    <DemoFrame
      mobileViewportHeight={mobileViewportMetrics?.height}
      mobileViewportPageTop={mobileViewportMetrics?.pageTop}
    >
      <div className="mission-frame-wrapper relative w-full h-full">
        ...
        <MissionInner
          ...
          onKeyboardViewportMetricsChange={setMobileViewportMetrics}
        />
        {!isTextMode && (
