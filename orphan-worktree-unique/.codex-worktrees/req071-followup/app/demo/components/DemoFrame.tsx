...
export function DemoFrame({
  ...
  mobileViewportPageTop,
}: {
  children: ReactNode;
  mobileViewportHeight?: number | null;
  mobileViewportPageTop?: number | null;
}) {
  ...
  const mobilePageTop = hasMobileViewportHeight && typeof mobileViewportPageTop === "number"
    ? Math.max(0, mobileViewportPageTop)
    : 0;
    ...
    return (
      <div
        ...
        style={{
          ...
          position: hasMobileViewportHeight ? "relative" : undefined,
          top: hasMobileViewportHeight ? `${mobilePageTop}px` : undefined,
        }}
      >
        {children}
      </div>
