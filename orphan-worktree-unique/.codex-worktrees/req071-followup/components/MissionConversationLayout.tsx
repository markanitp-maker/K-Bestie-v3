...
export function MissionConversationLayout({
  ...
  useLayoutEffect(() => {
    onKeyboardViewportMetricsChange?.(
      activeKeyboardViewportHeight
        ? { height: activeKeyboardViewportHeight, pageTop: viewportPageTop }
        : null,
    );
    return () => onKeyboardViewportMetricsChange?.(null);
  }, [activeKeyboardViewportHeight, onKeyboardViewportMetricsChange, viewportPageTop]);
