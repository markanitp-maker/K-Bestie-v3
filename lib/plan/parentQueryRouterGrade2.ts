...
export const POLICY_VERSION = "PQR-G2-1.0";
...
const CONFIG: RouterPolicyConfig = {
  ...
  redAreaPromptGuide:
    "emotion_cause(기분 원인 캐기), peer_conflict(친구 갈등·따돌림), academic_pressure(성적·공부 추궁), secret(비밀·거짓말 적발), family_complaint(가족 불만 확인)",
};
