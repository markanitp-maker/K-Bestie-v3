...
export const GRADE_PERSONAS: Readonly<Record<ElementaryGrade, GradePersona>> = Object.freeze({
  1: {
    ...
    responseLengthGuideline: "1문장, 짧은 감탄사 위주 (자연스러운 길이 — 강제 글자수 제한 아님)",
  ...
  2: {
    ...
    responseLengthGuideline: "1~2문장, 리액션+짧은 한마디",
  ...
  3: {
    ...
    responseLengthGuideline: "1~2문장, 공감 다음에 짧은 코멘트",
  ...
  4: {
    ...
    responseLengthGuideline: "1~2문장, 감정을 먼저 짚고 필요하면 한마디 더",
  ...
  5: {
    ...
    responseLengthGuideline: "1~2문장, 담백하게 — 과한 리액션 지양",
  ...
  6: {
    ...
    responseLengthGuideline: "1~2문장, 필요 없으면 리액션만으로도 충분",
