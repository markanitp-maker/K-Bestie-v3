  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "성장정보(선택): 보호자가 \'우리 아이 성장정보\' 기능을 사용하는 경우에만 아이의 생년월일, 측정일, 키, 몸무게를 처리합니다. 이용 목적은 보호자에게 아이의 성장 기록과 질병관리청 2017 소아청소년 성장도표 기반 비교 정보(백분위·또래 중앙값·체질량지수)를 제공하기 위함이며, 이 목적 외로 이용하지 않습니다. 성장정보는 보호자만 열람·수정·삭제할 수 있고 아이 화면에는 표시하지 않습니다. 연령·체질량지수·백분위 등 파생 정보는 별도로 저장하지 않고 조회 시 계산합니다. 기능을 사용하지 않으면 해당 정보를 수집하지 않으며, 동의하지 않아도 다른 서비스는 그대로 이용할 수 있습니다.",
        "현재 보호자의 휴대전화번호·주소·생년월일 및 아이의 관심사·이메일·휴대전화번호는 수집하지 않습니다.",
      ],
    },
    {
