...
export const PARENT_PII_CANDIDATE: LegalDocument = {
  ...
  sections: [
    ...
    {
      id: "external",
      title: "4. 외부 AI·클라우드 및 국외 처리",
      paragraphs: ["Supabase, Vercel 서비스에서 보호자 계정·인증 정보가 서비스 제공에 필요한 범위로 처리될 수 있습니다. 보호자 계정·인증 정보는 AI 대화 생성에 사용되지 않으므로 Google 계열 서비스로는 전달되지 않습니다. 수탁사별 이전받는 자, 이전국가, 연락처와 법적 근거는 개인정보 처리방침의 국외이전 항목에서 확인할 수 있습니다."],
    },
    {
      id: "refusal",
      title: "5. 동의 거부권",
