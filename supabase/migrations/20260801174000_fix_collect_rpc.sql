...
-- Drop all versions of collect_chat_messages_v3
DROP FUNCTION IF EXISTS public.collect_chat_messages_v3(uuid, text);
DROP FUNCTION IF EXISTS public.collect_chat_messages_v3(uuid, text, uuid, date, integer, timestamp with time zone, integer);
